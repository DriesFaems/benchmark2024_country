...
df = pd.read_excel('Aggregate country with country.xlsx')
...
st.subheader('This benchmarking tool allows you to compare different countries on different growth metrics. For more information on the European Scaleup Institute, visit https://scaleupinstitute.eu/. For more information on this benchmark tool, please reach out to info@scaleupinstitute.eu')
...
# Filtering data
filtered_data = df_long[df_long['Country'].isin(selected_countries)]
...
if clicked:
    ...
    newtable = newtable.set_index('Country')
